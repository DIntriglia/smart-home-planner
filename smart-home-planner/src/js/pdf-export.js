...
const _FOOTER_TEXT  = 'Generated by Smart Home Planner - smarthomecompared.com/planner';
...
function _pdfCoverPage(doc, { houseName, dateStr, stats, logoDataUrl }) {
    ...
    doc.text('smarthomecompared.com/planner', logoX + logoSize + 6, logoY + 12.8);
...
function _buildMarkdownReport(data, config, sections) {
    ...
    lines.push('_smarthomecompared.com/planner_', '');
